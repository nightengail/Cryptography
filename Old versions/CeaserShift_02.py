...
for letter in common_letters:
    ...
    letter_label.grid(row = 0, column = i+1, padx = (xl,2) , pady = 2, sticky = "")
    label.grid(row = 2, column = i+1, padx = (xl,2) , pady = 2, sticky = "")
    xl=2
    i = i+1
...
for letter in common_cypher_letters:
    ...
    letter_label.grid(row = 1, column = i+1, padx = (xl,2) , pady = 2, sticky = "")
    label.grid(row = 0, column = i+1, padx = (xl,2) , pady = 2, sticky = "")
    xl=2
    i = i+1
...
for i in range(26):
    ...
    letter_label.grid(row = i+1, column = 0, padx = 2 , pady = (yl,2), sticky = "")
    label.grid(row = i+1, column = 1, padx = 2 , pady = (yl,2), sticky = "")
    yl=2
    i = i+1
...
plain_frequency_frame.grid(row = 9, column = 0, rowspan = 3, columnspan = 6, padx = 2 , pady = 0, sticky = "nesw")
button_frame.grid(row = 12, column = 0, rowspan = 3, columnspan = 6, padx = 2 , pady = 2, sticky = "nesw")
cypher_frequency_frame.grid(row = 15, column = 0, rowspan = 3, columnspan = 6, padx = 2 , pady = 0, sticky = "nesw")
cyphertext_frame.grid(row = 18, column = 0, rowspan = 9, columnspan = 6, padx = 2 , pady = 2, sticky = "nesw")
